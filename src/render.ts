...
const app = new PIXI.Application({backgroundColor: 0x000000, width: 1200, height: 675})
...
var title1url = require('../assets/sprites/title-1.png')

const title = PIXI.Sprite.from(title1url)
